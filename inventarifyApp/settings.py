"""
Django settings for inventarifyApp project.
...
SECRET_KEY = 'django-insecure-p1ahsrty@b99_=h=n&4u4b5rn!*sd&r!w-)pxyks($go%p#7_s'
...
WSGI_APPLICATION = 'inventarifyApp.wsgi.application'
...
#Establecer Redireciones para hacer Login y Logout
